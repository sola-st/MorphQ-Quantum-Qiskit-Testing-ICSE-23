...
qc.append(CCXGate(), qargs=[qr[7], qr[6], qr[9]], cargs=[])
...
backend_c78d41fefbd5440f83de92ef37fbd821 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_c78d41fefbd5440f83de92ef37fbd821, shots=5542).result().get_counts(qc)
RESULT = counts