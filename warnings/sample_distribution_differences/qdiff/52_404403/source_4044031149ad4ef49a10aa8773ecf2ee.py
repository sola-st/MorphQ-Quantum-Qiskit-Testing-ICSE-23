...
backend_68faa96ad32f4ab9baf3ac26e37b582f = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_68faa96ad32f4ab9baf3ac26e37b582f, shots=2771).result().get_counts(qc)
RESULT = counts