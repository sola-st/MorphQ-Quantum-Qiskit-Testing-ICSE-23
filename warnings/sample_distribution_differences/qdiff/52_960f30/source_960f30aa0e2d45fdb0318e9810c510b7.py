...
qc.append(CCXGate(), qargs=[qr[8], qr[1], qr[2]], cargs=[])
...
backend_6207f57798ca40c49020edcbc9b75e4e = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_6207f57798ca40c49020edcbc9b75e4e, shots=7838).result().get_counts(qc)
RESULT = counts