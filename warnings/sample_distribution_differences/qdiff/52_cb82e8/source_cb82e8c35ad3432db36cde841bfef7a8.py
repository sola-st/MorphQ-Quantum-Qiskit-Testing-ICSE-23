...
backend_ad46c3ef3ab846839ec3074662abb067 = Aer.get_backend('qasm_simulator')
counts = execute(qc, backend=backend_ad46c3ef3ab846839ec3074662abb067, shots=3919).result().get_counts(qc)
RESULT = counts