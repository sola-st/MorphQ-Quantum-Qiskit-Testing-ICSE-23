...
qc.append(CXGate(), qargs=[qr[1], qr[8]], cargs=[])
qc.append(TGate().inverse(), qargs=[qr[8]], cargs=[])
qc.append(CXGate(), qargs=[qr[5], qr[8]], cargs=[])
...
qc.append(HGate(), qargs=[qr[8]], cargs=[])
qc.append(CXGate(), qargs=[qr[5], qr[1]], cargs=[])
...
qc.append(CSXGate(), qargs=[qr[8], qr[7]], cargs=[])
# SECTION
# NAME: MEASUREMENT
...
backend_ad46c3ef3ab846839ec3074662abb067 = Aer.get_backend('aer_simulator')
counts = execute(qc, backend=backend_ad46c3ef3ab846839ec3074662abb067,
