...
qr_8e82ee = QuantumRegister(5, name='qr_8e82ee')
qc_2.add_register(qr_8e82ee)
# SECTION
# NAME: MEASUREMENT
...
backend_84441fcfe4544470b6d5bae3a03210ab = Aer.get_backend('qasm_simulator')
counts_1 = execute(qc_1, backend=backend_84441fcfe4544470b6d5bae3a03210ab, shots=7838).result().get_counts(qc_1)
counts_2 = execute(qc_2, backend=backend_84441fcfe4544470b6d5bae3a03210ab, shots=7838).result().get_counts(qc_2)
