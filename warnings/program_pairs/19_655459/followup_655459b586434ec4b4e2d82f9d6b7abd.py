...
subcircuit.append(C4XGate(), qargs=[qr[6], qr[2], qr[0], qr[5], qr[7]], cargs=[])
subcircuit.append(UGate(1.0031573807005563, 2.943079680188436, 6.117218154099855), qargs=[qr[0]], cargs=[])
...
qr_eb8f6b = QuantumRegister(9, name='qr_eb8f6b')
qc.add_register(qr_eb8f6b)
# SECTION
# NAME: MEASUREMENT
